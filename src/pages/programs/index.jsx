...
const Programs = () => {
  ...
  const mockFaculty = [
    ...
    },
    {
      ...
      qualifications: [
        "Ph.D. in Management, Harvard Business School",
        "MBA, Wharton School",
      ],
      experience: 20,
      researchAreas: [
  ...
  const filterPrograms = () => {
    ...
    if (activeFilters?.department !== "all") {
      filtered = filtered?.filter((program) =>
        program?.department
          ?.toLowerCase()
          ?.includes(activeFilters?.department?.toLowerCase())
      );
    }
    ...
    if (activeFilters?.minPlacement > 0) {
      filtered = filtered?.filter(
        (program) =>
          program?.placementRate >= parseInt(activeFilters?.minPlacement)
      );
    }
  ...
  const handleCompareProgram = (program) => {
    const isAlreadyComparing = comparePrograms?.some(
      (p) => p?.id === program?.id
    );
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="text-center">
            ...
            <p className="text-lg text-white/80 max-w-3xl mx-auto mb-8">
              ...
              programs designed to prepare you for global opportunities while
              maintaining cultural pride in Bengali heritage. Transform your
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {filteredPrograms?.map((program) => (
              <ProgramCard
                ...
                isComparing={comparePrograms?.some(
                  (p) => p?.id === program?.id
                )}
              />
            ))}
        ...
        <div className="bg-gradient-to-r from-primary to-innovation rounded-xl p-8 text-white text-center">
          ...
          <p className="text-lg text-white/90 mb-6 max-w-2xl mx-auto">
            ...
            potential into professional excellence at DIIT. Your future starts
            here.
          </p>
